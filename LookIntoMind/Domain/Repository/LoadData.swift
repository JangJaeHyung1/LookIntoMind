...
struct Dummy {
    ...
    [.init(date: Calendar.current.date(from: DateComponents(year: 2023, month: 12, day: 01))!, category: .affection, subCategory: SubCategory.array[.affection]![0], content: "23년 12월 일기"),
     .init(date: Calendar.current.date(from: DateComponents(year: 2022, month: 11, day: 02))!, category: .worry, subCategory: SubCategory.array[.worry]![0], content: "22년 11월 일기"),
